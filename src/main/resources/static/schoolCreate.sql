...
CREATE TABLE IF NOT EXISTS `school`.`Picture` (
  ...
  `picture_category` INT NOT NULL COMMENT '文章分类',
...
-- -----------------------------------------------------
-- Table `school`.`File_info`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `school`.`File_info` ;

CREATE TABLE IF NOT EXISTS `school`.`File_info` (
